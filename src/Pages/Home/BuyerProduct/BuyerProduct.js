              ...
              <Grid container spacing={2} columns={{ xs: 4, sm: 8, md: 4 }}>
                <Grid item xs={12} sm={12} md={12}>
                  <div className='photo'>
                    <div className='photoShops'>
                      <img height="230" width="250" style={{ borderRadius: "15px" }} src={single?.img} alt=""></img>
                ...
                <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                  <Box style={{ textAlign: "left" }}>
                    ...
                    <br />
                    {/* like handler ================== */}
                    <Button onClick={() => handleLike(single?._id)}>Like</Button>
                    <Button onClick={() => handleUnLike(single?._id)}>Unlike</Button>
